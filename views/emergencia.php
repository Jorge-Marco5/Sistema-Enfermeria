...
<body>
  ...
  <main>
    ...
    <p class="text-uppercase text-dark">Ingresa la matricula de la persona que tuvo el accidente</p>
      ...
      <table class="table user-table">
        <thead style="position: sticky; top: 0; background-color: #2d8ca2; color: white;">
          <tr>
            ...
            <th style="width: 16.5%">Datos de emergencia</th>
          </tr>
        </thead>
        <tbody>
          <?php foreach ($result as $fila) { ?>
            <tr>
              ...
              <td>
                <a
                  href="../Controllers/descargaExcel.php?matricula=<?php echo htmlspecialchars($fila['matricula'], ENT_QUOTES); ?>">
