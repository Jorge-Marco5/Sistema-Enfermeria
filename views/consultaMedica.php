                ...
                <form id="formConsultaMedica" action="../Controllers/aggConsultaMedica.php" method="POST"
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-row ">
                                <div class="col-auto form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" name="temperatura" class="form-control" placeholder="36.5"
                                ...
                                <div class="col-auto form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" name="presion_arterial" class="form-control"
                                            placeholder="120/80" pattern="\d{2,3}/\d{2,3}" title="Formato: 120/80">
                                        <div class="input-group-append">
                                ...
                                <div class="col-auto form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" name="peso" class="form-control" placeholder="70.50"
                                ...
                                <div class="col-auto form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" name="estatura" class="form-control" placeholder="1.75"
                        ...
                        <div class="panel form-group">
                            ...
                            <textarea class="form-control" name="diagnostico" id="description1" rows="3"
                                placeholder="Diagnostico y pruebas realizadas..."></textarea>
                        </div>

                        <div class="panel form-group">
                            <h1 class="nombreEtiqueta">Tratamiento: </h1>
                            <textarea class="form-control" name="tratamiento" id="description1" rows="3"
